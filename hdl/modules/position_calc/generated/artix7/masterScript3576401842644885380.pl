...
$ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'coregen_core_generation_tmpdir' => 'C:/TEMP/sysgentmp-lucas.russo/cg_wk/c7f508b69e5ec6409',
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  open(RESULTS, '> D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066_artix7/sysgen/script_results2384066948266179811') || 
    croak 'couldn\'t open D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066_artix7/sysgen/script_results2384066948266179811';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066_artix7/sysgen/script_results2384066948266179811';
};
