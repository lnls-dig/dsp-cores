...
$ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'coregen_core_generation_tmpdir' => 'C:/TEMP/sysgentmp-lucas.russo/cg_wk/cdb6f725de847aa51',
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  $instrs = [
    ...
    'SET package = ffg1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_483a28da4a562c1e',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '8cf177474548a21890edbefccf15b21c',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_6508759a07908936c4d12ef4ec464ceb',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  open(RESULTS, '> D:/Sysgen_projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_artix7/sysgen/script_results6291993821524256745') || 
    croak 'couldn\'t open D:/Sysgen_projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_artix7/sysgen/script_results6291993821524256745';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing D:/Sysgen_projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_artix7/sysgen/script_results6291993821524256745';
};
