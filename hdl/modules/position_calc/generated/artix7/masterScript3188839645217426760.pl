...
$ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'coregen_core_generation_tmpdir' => 'C:/TEMP/sysgentmp-lucas.russo/cg_wk/cdf10804425d50db8',
    ...
    'device_speed' => '-1',
    'directory' => 'D:/Sysgen_projects/dsp-cores-slac-test-rffe_v1/models/netlist_ddc_bpm_476_066_artix7',
    'dsp_cache_root_path' => 'C:/TEMP/sysgentmp-lucas.russo',
    'eval_field' => '0',
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => 'D:/Sysgen_projects/dsp-cores-slac-test-rffe_v1/models/netlist_ddc_bpm_476_066_artix7/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => 'D:/Sysgen_projects/dsp-cores-slac-test-rffe_v1/models/netlist_ddc_bpm_476_066_artix7/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 1.0,
...
fprintf(\'\',\'COMMENT: end icon text\');',
    ...
    'testbench' => 0,
    'testbench_sgadvanced' => '',
    'tmpDir' => 'D:/Sysgen_projects/dsp-cores-slac-test-rffe_v1/models/netlist_ddc_bpm_476_066_artix7/sysgen',
    'trim_vbits' => 1.0,
    'trim_vbits_sgadvanced' => '',
    'use_ce_syn_keep' => 1,
    'use_strict_names' => 1,
...
begin
  ...
  $instrs = [
    ...
    'SET package = ffg1156',
    'SET speedgrade = -1',
    'CSET component_name = cc_cmplr_v3_0_7323c2785151974c',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '421d426f3581cd5524866465e3dc37b8',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
  component cc_cmplr_v3_0_7323c2785151974c
    port(
      aclk:in std_logic;
      aclken:in std_logic;
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  cc_cmplr_v3_0_7323c2785151974c_instance : cc_cmplr_v3_0_7323c2785151974c
    port map(
      aclk=>clk,
      aclken=>ce,
  ...
  port(
    ...
    s_axis_data_tready:out std_logic
      ...
      'entity_name' => 'xlcic_compiler_7154e76995c5d97184b4d49fe80ba674',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  $instrs = [
    ...
    'SET package = ffg1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_0c5343f883152f35',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'a129a01833ced442fbd0ce5c5557dcee',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
  component fr_cmplr_v6_3_0c5343f883152f35
    port(
      aclk:in std_logic;
      aclken:in std_logic;
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  fr_cmplr_v6_3_0c5343f883152f35_instance : fr_cmplr_v6_3_0c5343f883152f35
    port map(
      aclk=>clk,
      aclken=>ce,
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_7b491ad8d4ba5eabd2227328ade05abc',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = [
    ...
    'SET package = ffg1156',
    'SET speedgrade = -1',
    'CSET component_name = cc_cmplr_v3_0_3806dcf7c55070c5',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '057a2f5cf4e05acc6e92192d35835652',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
  component cc_cmplr_v3_0_3806dcf7c55070c5
    port(
      aclk:in std_logic;
      aclken:in std_logic;
      event_tlast_missing:out std_logic;
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  cc_cmplr_v3_0_3806dcf7c55070c5_instance : cc_cmplr_v3_0_3806dcf7c55070c5
    port map(
      aclk=>clk,
      aclken=>ce,
      event_tlast_missing=>event_tlast_missing,
  ...
  port(
    ...
    s_axis_data_tready:out std_logic
      ...
      'entity_name' => 'xlcic_compiler_4e10494923e5cac253b6f1d2e8f3bc11',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = [
    ...
    'SET package = ffg1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_a2b5511a102bea59',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '97f5badb5f0313d9cff1121d3dfc06b8',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
  component fr_cmplr_v6_3_a2b5511a102bea59
    port(
      aclk:in std_logic;
      aclken:in std_logic;
      event_s_data_chanid_incorrect:out std_logic;
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  fr_cmplr_v6_3_a2b5511a102bea59_instance : fr_cmplr_v6_3_a2b5511a102bea59
    port map(
      aclk=>clk,
      aclken=>ce,
      event_s_data_chanid_incorrect=>event_s_data_chanid_incorrect,
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_934ebf61b07be01f5aeb653266c3130e',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
  ...
  $instrs = [
    ...
    'SET package = ffg1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_d69894653572ab3a',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '4f27ef8a5e6f5839868eb2f6159c87f5',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
  component fr_cmplr_v6_3_d69894653572ab3a
    port(
      aclk:in std_logic;
      aclken:in std_logic;
      event_s_data_chanid_incorrect:out std_logic;
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  fr_cmplr_v6_3_d69894653572ab3a_instance : fr_cmplr_v6_3_d69894653572ab3a
    port map(
      aclk=>clk,
      aclken=>ce,
      event_s_data_chanid_incorrect=>event_s_data_chanid_incorrect,
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_2999960fcfa1e3c2ca2fbe30c84f30d7',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  $instrs = [
    ...
    'SET package = ffg1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_f58d61716b45971c',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '4cd0ca60a9beef80af3d256237da74e6',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
  component fr_cmplr_v6_3_f58d61716b45971c
    port(
      aclk:in std_logic;
      aclken:in std_logic;
      event_s_data_chanid_incorrect:out std_logic;
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  fr_cmplr_v6_3_f58d61716b45971c_instance : fr_cmplr_v6_3_f58d61716b45971c
    port map(
      aclk=>clk,
      aclken=>ce,
      event_s_data_chanid_incorrect=>event_s_data_chanid_incorrect,
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_be19bf6ca13de3be5721c9463ca74853',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  open(RESULTS, '> D:/Sysgen_projects/dsp-cores-slac-test-rffe_v1/models/netlist_ddc_bpm_476_066_artix7/sysgen/script_results6439316962384360382') || 
    croak 'couldn\'t open D:/Sysgen_projects/dsp-cores-slac-test-rffe_v1/models/netlist_ddc_bpm_476_066_artix7/sysgen/script_results6439316962384360382';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing D:/Sysgen_projects/dsp-cores-slac-test-rffe_v1/models/netlist_ddc_bpm_476_066_artix7/sysgen/script_results6439316962384360382';
};
