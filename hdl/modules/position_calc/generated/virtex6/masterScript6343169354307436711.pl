...
$ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'coregen_core_generation_tmpdir' => 'C:/TEMP/sysgentmp-lucas.russo/cg_wk/c6e67eba7430b4d5a',
    ...
    'device_speed' => '-1',
    'directory' => 'D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066',
    'dsp_cache_root_path' => 'C:/TEMP/sysgentmp-lucas.russo',
    'eval_field' => '0',
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => 'D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => 'D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 1.0,
    ...
    'isdeployed' => 0,
    'ise_version' => '13.4i',
    'master_sysgen_token_handle' => 2085.7572021484375,
...
fprintf(\'\',\'COMMENT: end icon text\');',
    ...
    'testbench' => 0,
    'testbench_sgadvanced' => '',
    'tmpDir' => 'D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066/sysgen',
    'trim_vbits' => 1.0,
    'trim_vbits_sgadvanced' => '',
    'use_ce_syn_keep' => 1,
    'use_strict_names' => 1,
...
begin
  ...
  $instrs = [
    ...
    'SET package = ff1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_1463b5af78ac5ae9',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '13af7f26858d03f8924ea18cebbd09ef',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_050c369b674b0d165d95450c3101ab48',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '0143bc8bd75de4d760dfad8ef85df45d',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_dout_tdata_shift_out_net <= shift_division_result(m_axis_dout_tdata_quotient_net, m_axis_dout_tdata_fractional_net, 25, 0, 0);
  ...
  port(
    ...
    s_axis_divisor_tvalid:in std_logic
      ...
      'entity_name' => 'xldivider_generator_66a16853278bd0055273accc6a1f1f05',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  $instrs = [
    ...
    'CSET outtready = false',
    'CSET remainder_type = Fractional',
    'CSET component_name = dv_gn_v4_0_6f80dffc6505f52d',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'c1427eb015468ff1c4a0116510a206ad',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_dout_tdata_shift_out_net <= shift_division_result(m_axis_dout_tdata_quotient_net, m_axis_dout_tdata_fractional_net, 25, 0, 1);
  ...
  port(
    ...
    s_axis_divisor_tvalid:in std_logic
      ...
      'entity_name' => 'xldivider_generator_2b8e0a6ab4abb7b606628f314742e249',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = [
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'ead06ba3357991a9079f0d09aebd0a8b',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_dout_tdata_shift_out_net <= shift_division_result(m_axis_dout_tdata_quotient_net, m_axis_dout_tdata_fractional_net, 25, 0, 0);
  ...
  port(
    ...
    s_axis_divisor_tvalid:in std_logic
      ...
      'entity_name' => 'xldivider_generator_0f8a721314b1c7fdd5dc9789f24ac993',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = [
    ...
    'CSET outtready = false',
    'CSET remainder_type = Fractional',
    'CSET component_name = dv_gn_v4_0_7ef58ec245a610b4',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '3f7715ab10aa43be214e50de4b41cc90',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_dout_tdata_shift_out_net <= shift_division_result(m_axis_dout_tdata_quotient_net, m_axis_dout_tdata_fractional_net, 25, 0, 1);
  ...
  port(
    ...
    s_axis_divisor_tvalid:in std_logic
      ...
      'entity_name' => 'xldivider_generator_f233dc286cb089d5deada4c083704bfa',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  $instrs = [
    ...
    'SET package = ff1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_7533d5f0521a268c',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'ce7e3372b9cef81275dfbca6912ce4eb',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_900a56d1a5f0adb193f4f20c2a21bcc9',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  open(RESULTS, '> D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066/sysgen/script_results261461165202201471') || 
    croak 'couldn\'t open D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066/sysgen/script_results261461165202201471';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066/sysgen/script_results261461165202201471';
};
