...
$ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'coregen_core_generation_tmpdir' => 'C:/TEMP/sysgentmp-lucas.russo/cg_wk/c9e60cc2b5459ebf2',
...
begin
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '6df0c2c28c36f3ae6f1935f5cf696989',
...
begin
  ...
  $instrs = [
    ...
    'SET package = ff1156',
    'SET speedgrade = -1',
    'CSET component_name = cc_cmplr_v3_0_59fbd17f7e62a7fe',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'ca4f3a3709d6bb2b828741a7849dedba',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  port(
    ...
    s_axis_data_tready:out std_logic
      ...
      'entity_name' => 'xlcic_compiler_7373a9a257c6e448caebe0d43b2c869b',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'afd33db8e1db89bfce1095ce80d3ec32',
    'sourceFile' => 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  open(RESULTS, '> D:/Sysgen_projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_virtex6/sysgen/script_results2084205746619877190') || 
    croak 'couldn\'t open D:/Sysgen_projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_virtex6/sysgen/script_results2084205746619877190';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing D:/Sysgen_projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_virtex6/sysgen/script_results2084205746619877190';
};
