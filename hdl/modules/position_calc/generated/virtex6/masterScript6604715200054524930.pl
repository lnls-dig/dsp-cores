...
$ENV{'SYSGEN'} = 'F:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'coregen_core_generation_tmpdir' => 'C:/TEMP/sysgentmp-Lerwys/cg_wk/c43b7b73bbb0f2646',
    ...
    'device_speed' => '-1',
    'directory' => 'F:/Xlinx_Projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_virtex6',
    'dsp_cache_root_path' => 'C:/TEMP/sysgentmp-Lerwys',
    'eval_field' => '0',
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => 'F:/Xlinx_Projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_virtex6/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => 'F:/Xlinx_Projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_virtex6/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 1.0,
...
fprintf(\'\',\'COMMENT: end icon text\');',
    ...
    'testbench' => 0,
    'testbench_sgadvanced' => '',
    'tmpDir' => 'F:/Xlinx_Projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_virtex6/sysgen',
    'trim_vbits' => 1.0,
    'trim_vbits_sgadvanced' => '',
    'use_ce_syn_keep' => 1,
    'use_strict_names' => 1,
...
begin
  ...
  $instrs = [
    ...
    'SET package = ff1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_7a31d7bad92d10e1',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'a775912dfcbe6f828cfb14a6ed7b80ce',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_51c5153565daf9c16a56082552c5fab1',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = [
    ...
    'SET package = ff1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_8243071c64d437f6',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '54ef97ab451037aa32208c250b3f8447',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_ba9b5011f8762802f29bd8f59c7e39fd',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  $instrs = [
    ...
    'SET package = ff1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_e5c5a71b49aa273f',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'eb807a9bfecd0027417fbd8afd4b1c98',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_78e88e4f9a8c14edbd33ad2b1e90090d',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = 'F:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  open(RESULTS, '> F:/Xlinx_Projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_virtex6/sysgen/script_results8647313585098342245') || 
    croak 'couldn\'t open F:/Xlinx_Projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_virtex6/sysgen/script_results8647313585098342245';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing F:/Xlinx_Projects/dsp-cores-devel/models/netlist_ddc_bpm_476_066_virtex6/sysgen/script_results8647313585098342245';
};
