...
$ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'coregen_core_generation_tmpdir' => 'C:/TEMP/sysgentmp-lucas.russo/cg_wk/cad01b12deca4530a',
    ...
    'device_speed' => '-1',
    'directory' => 'D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066_virtex6',
    'dsp_cache_root_path' => 'C:/TEMP/sysgentmp-lucas.russo',
    'eval_field' => '0',
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => 'D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066_virtex6/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => 'D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066_virtex6/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 1.0,
...
fprintf(\'\',\'COMMENT: end icon text\');',
    ...
    'testbench' => 0,
    'testbench_sgadvanced' => '',
    'tmpDir' => 'D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066_virtex6/sysgen',
    'trim_vbits' => 1.0,
    'trim_vbits_sgadvanced' => '',
    'use_ce_syn_keep' => 1,
    'use_strict_names' => 1,
...
begin
  ...
  $instrs = [
    ...
    'SET package = ff1156',
    'SET speedgrade = -1',
    'CSET component_name = fr_cmplr_v6_3_ef12b9ceb2663ded',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '99f3a5e6a55a0c4e5d18ffa9164bca5c',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => ' is
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  port(
    ...
    src_clk:in std_logic
      ...
      'entity_name' => 'xlfir_compiler_95e9088857efcec89604b83f54658c12',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
m_axis_data_tvalid_ps_net_synchronizer_2 : entity work.synth_reg_w_init
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = 'C:/Xilinx/13.4/ISE_DS/ISE/sysgen';
  open(RESULTS, '> D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066_virtex6/sysgen/script_results7052545188735269615') || 
    croak 'couldn\'t open D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066_virtex6/sysgen/script_results7052545188735269615';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing D:/Sysgen_projects/dsp-cores-master/models/netlist_ddc_bpm_476_066_virtex6/sysgen/script_results7052545188735269615';
};
