...
entity xwb_position_calc_core_ns is
generic
(
...
end xwb_position_calc_core_ns;

architecture rtl of xwb_position_calc_core_ns is

begin

  cmp_wb_position_calc_core : wb_position_calc_core_ns
  generic map
  (
