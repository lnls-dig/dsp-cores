...
#define POS_CALC_KX_VAL_MASK                  WBGEN2_GEN_MASK(0, 26)
#define POS_CALC_KX_VAL_SHIFT                 0
#define POS_CALC_KX_VAL_W(value)              WBGEN2_GEN_WRITE(value, 0, 26)
#define POS_CALC_KX_VAL_R(reg)                WBGEN2_GEN_READ(reg, 0, 26)

/* definitions for field: Reserved in reg: BPM sensitivity (X axis) parameter register */
#define POS_CALC_KX_RESERVED_MASK             WBGEN2_GEN_MASK(26, 6)
#define POS_CALC_KX_RESERVED_SHIFT            26
#define POS_CALC_KX_RESERVED_W(value)         WBGEN2_GEN_WRITE(value, 26, 6)
#define POS_CALC_KX_RESERVED_R(reg)           WBGEN2_GEN_READ(reg, 26, 6)
...
#define POS_CALC_KY_VAL_MASK                  WBGEN2_GEN_MASK(0, 26)
#define POS_CALC_KY_VAL_SHIFT                 0
#define POS_CALC_KY_VAL_W(value)              WBGEN2_GEN_WRITE(value, 0, 26)
#define POS_CALC_KY_VAL_R(reg)                WBGEN2_GEN_READ(reg, 0, 26)

/* definitions for field: Reserved in reg: BPM sensitivity (Y axis) parameter register */
#define POS_CALC_KY_RESERVED_MASK             WBGEN2_GEN_MASK(26, 6)
#define POS_CALC_KY_RESERVED_SHIFT            26
#define POS_CALC_KY_RESERVED_W(value)         WBGEN2_GEN_WRITE(value, 26, 6)
#define POS_CALC_KY_RESERVED_R(reg)           WBGEN2_GEN_READ(reg, 26, 6)
...
#define POS_CALC_KSUM_VAL_MASK                WBGEN2_GEN_MASK(0, 26)
#define POS_CALC_KSUM_VAL_SHIFT               0
#define POS_CALC_KSUM_VAL_W(value)            WBGEN2_GEN_WRITE(value, 0, 26)
#define POS_CALC_KSUM_VAL_R(reg)              WBGEN2_GEN_READ(reg, 0, 26)

/* definitions for field: Reserved in reg: BPM sensitivity (Sum) parameter register */
#define POS_CALC_KSUM_RESERVED_MASK           WBGEN2_GEN_MASK(26, 6)
#define POS_CALC_KSUM_RESERVED_SHIFT          26
#define POS_CALC_KSUM_RESERVED_W(value)       WBGEN2_GEN_WRITE(value, 26, 6)
#define POS_CALC_KSUM_RESERVED_R(reg)         WBGEN2_GEN_READ(reg, 26, 6)
...
PACKED struct POS_CALC_WB {
  ...
  /* [0x28]: REG DDS general config registers for all channels */
  uint32_t DDS_CFG;
  /* [0x2c]: REG DDS phase increment parameter register for channel 0 */
  uint32_t DDS_PINC_CH0;
  /* [0x30]: REG DDS phase increment parameter register for channel 1 */
  uint32_t DDS_PINC_CH1;
  /* [0x34]: REG DDS phase increment parameter register for channel 2 */
  uint32_t DDS_PINC_CH2;
  /* [0x38]: REG DDS phase increment parameter register for channel 3 */
  uint32_t DDS_PINC_CH3;
  /* [0x3c]: REG DDS phase offset parameter register for channel 0 */
  uint32_t DDS_POFF_CH0;
  /* [0x40]: REG DDS phase offset parameter register for channel 1 */
  uint32_t DDS_POFF_CH1;
  /* [0x44]: REG DDS phase offset parameter register for channel 2 */
  uint32_t DDS_POFF_CH2;
  /* [0x48]: REG DDS phase offset parameter register for channel 3 */
