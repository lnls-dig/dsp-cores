...
package pos_calc_wbgen2_pkg is
  ...
  constant c_pos_calc_in_registers_init_value: t_pos_calc_in_registers := (
    ...
    type t_pos_calc_out_registers is record
      ...
      ampfifo_wr_full_o                        : std_logic;
      ampfifo_wr_empty_o                       : std_logic;
      ampfifo_wr_usedw_o                       : std_logic_vector(3 downto 0);
      posfifo_wr_full_o                        : std_logic;
      posfifo_wr_empty_o                       : std_logic;
      posfifo_wr_usedw_o                       : std_logic_vector(3 downto 0);
      end record;
    ...
    constant c_pos_calc_out_registers_init_value: t_pos_calc_out_registers := (
      ...
      ampfifo_wr_full_o => '0',
      ampfifo_wr_empty_o => '0',
      ampfifo_wr_usedw_o => (others => '0'),
      posfifo_wr_full_o => '0',
      posfifo_wr_empty_o => '0',
      posfifo_wr_usedw_o => (others => '0')
      );
...
tmp.ampfifo_wr_req_i := f_x_to_zero(left.ampfifo_wr_req_i) or f_x_to_zero(right.ampfifo_wr_req_i);
...
tmp.posfifo_wr_req_i := f_x_to_zero(left.posfifo_wr_req_i) or f_x_to_zero(right.posfifo_wr_req_i);
