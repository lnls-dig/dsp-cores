...
a = np.linspace(0, val_max, num_samples)
b = np.random.random_integers(0, val_max, num_samples)
c = np.random.random_integers(0, val_max, num_samples)
d = np.random.random_integers(0, val_max, num_samples)

output = np.transpose([tgd, adr, a, b, c, d])
